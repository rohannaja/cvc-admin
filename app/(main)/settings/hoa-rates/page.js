...
import hoset from "./hoset.module.css";
...
export default function GarbageCollectionSettings() {
    ...
    const [miscType, setMiscType] = useState("hoa_rate");
    ...
    // Filter for items with misc_type === "hoa_rate"
    const hoaRateData = miscData.filter(miscInfo => miscInfo.misc_type === "hoa_rate");
        ...
        <div className={settings.main_content_container}>
            <div className={settings.main_content_div}>
                ...
                <div className={settings.main_settings_content_div}>
                    {/* Modal */}
                    {showModal && (
                        <div className={hoset.settings_garbage_modal_div}>
                            <div className={hoset.settings_garbage_modal_content}>
                                <div className={settings.settings_content_cta_row}>
                                    <h5 className={settings.settings_content_title}>Add HOA Collection Rate</h5>
                                </div>
                    ...
                    {!showModal && (
                        <div className={settings.main_settings_content}>
                            <div className={settings.settings_content_cta_row}>
                                <h5 className={settings.settings_content_title}>HOA Rates</h5>

                                <div className={hoset.settings_cta_btn_div}>
                                    <button 
                                        className={hoset.settings_cta_btn} 
                            ...
                            <div className={settings.settings_content_div}>
                                ...
                                {hoaRateData.length > 0 ? (
                                    hoaRateData.map((item) => (
